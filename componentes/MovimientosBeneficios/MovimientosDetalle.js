...
function MovimientosDetalle ({ navigation }){
    ...
    const eliminar=()=>{
        ...
        setConceptoelimnar(item.NombreEntidad)
        showDialog(true)
    ...
    const confimareliminacion = async()=>{
        setGuardando(true)
        const datoseliminar = {
            movimientos:codigoeliminar,};
    
    
        const endpoint='EliminarMovimientoBeneficio/'
        ...
        const unsubscribe = navigation.addListener('focus', () => {
            ...
            headerRight: () => (
                <View style={{flexDirection: 'row',alignItems: 'center'}}>
                    ...
                    <TouchableOpacity style={{ marginRight: 10 }} onPress={() => {navigate("MovimientosTransaccion", { item});}}>
            ...
            if(item.recarga==='si'){
                ...
                const cargardatos=async()=>{
                    ...
                    const body = {};
                    const endpoint='MisMovimientosBeneficios/' + anno_storage +'/' + mes_storage + '/'+ idact + '/'
                    ...
                    <View style={{flex: 1,marginTop:50,width:'90%',marginLeft:20,}}>
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center',height:50,paddingLeft:20,paddingRight:20,
                            ...
                            <Text style={[{ color: colors.text}]}>
                                ...
                                {datositem.NombreMesBeneficio} / {item.AnnoBeneficio}
                            </Text>
                        </View>
                        ...
                        <View style={{alignItems:'center',justifyContent:'space-between',marginTop:30}}>
                            ...
                            <Text style={[styles.contenedortexto,{ color: colors.text,fontSize:25,fontWeight:'bold'}]}>
                                ...
                                Gs. {Number(datositem.monto).toLocaleString('es-ES')}
                            </Text>
                            <Divider />
                            <Divider />
                            <Text style={[styles.contenedortexto,{ color: colors.text}]}>
                                
                                {datositem.NombreEntidad}
                            </Text>
                            <Divider />
                            <Divider />
                            ...
                            <Text style={[styles.contenedortexto,{ color: colors.text}]}>
                                ...
                                {moment(datositem.fecha_beneficio).format('DD/MM/YYYY')}
                            </Text>
                        </View>
