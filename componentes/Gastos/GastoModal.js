...
function GastoModal({visible,setVisible,recargadatos,setRecargadatos}){
    ...
    return(
        <Modal visible={visible} onDismiss={cerrar} contentContainerStyle={containerStyle}>
            <Text style={{fontSize:22, fontWeight:'bold' }}>Nuevo Registro</Text>
            <Divider />

            <View style={{padding:15}}>

                <View style={styles.contornoopciones}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={[styles.input, { width:'80%',height:'70%'}]}>
...
const styles = StyleSheet.create({
    ...
    botoncomando:{
      backgroundColor: 'blue',
      width: 70, // Define el ancho del botón
      height: 40, // Define la altura del botón
      borderRadius: 5, // Define la mitad de la dimensión del botón para obtener una forma circular
      justifyContent: 'center', // Alinea el contenido (icono) verticalmente en el centro
      alignItems: 'center',
