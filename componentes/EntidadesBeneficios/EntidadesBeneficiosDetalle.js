...
function EntidadesBeneficiosDetalle ({ navigation }){
    ...
    const eliminar=()=>{
        ...
        setConceptoelimnar(concepto.nombre_entidad)
        showDialog(true)
    ...
    const confimareliminacion = async()=>{
        setGuardando(true)
        const datoseliminar = {
            enitidades:codigoeliminar,};
    
    
        const endpoint='EliminarEntidadesBeneficios/'
        ...
        const unsubscribe = navigation.addListener('focus', () => {
            ...
            headerRight: () => (
                <View style={{flexDirection: 'row',alignItems: 'center'}}>
                    ...
                    <TouchableOpacity style={{ marginRight: 10 }} onPress={() => {navigate("EntidadesBeneficiosRegistro", { concepto});}}>
            ...
            if(concepto.recarga==='si'){
                ...
                const cargardatos=async()=>{
                    ...
                    const body = {};
                    const endpoint='MisEntidadesBeneficios/' + idact +'/' 
                    ...
                    <View style={{flex: 1,
                        ...
                        <View style={{ flexDirection: 'row',alignItems: 'center',height:50,
                            ...
                            <Text style={[{ color: colors.text}]}>
                                <Text style={[{ color: colors.text}]}>ID Entidad:</Text>{' '}
                                {datositem.id}
                            </Text>
...
export default EntidadesBeneficiosDetalle