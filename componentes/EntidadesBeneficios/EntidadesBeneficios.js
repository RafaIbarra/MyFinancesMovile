...
function EntidadesBeneficios ({ navigation  }){
    ...
    const handlePress = () => {
        ...
        const concepto={'id':0,'nombre_entidad':'','anotacion':''}
        navigate("EntidadesBeneficiosRegistro", { concepto})
    ...
    const realizarbusqueda= (palabra)=>{
      ...
      let arrayencontrado = dataingresoscompleto.filter(item => 
        item.nombre_entidad.toLowerCase().includes(pal)
        );
    ...
    }, [estadocomponente.entidadesbeneficioscomp]);
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1 }}>    
                <View style={styles.cabeceracontainer}>
                    ...
                    <Text style={[styles.titulocabecera, { color: colors.text}]}>Entidades Beneficios</Text>
                        ...
                        <View style={{ flexDirection: 'row', marginBottom: 10,marginLeft:5,marginRight:5 }}>
                            {item.map(concepto => (
                                    ...
                                    <TouchableOpacity key={concepto.id} 
                                                      ...
                                                      onPress={() => {navigate('EntidadesBeneficiosDetalle', { concepto });}}
                                                      >


                                        <LinearGradient
                                        key={concepto.nombre_entidad} 
                                        ...
                                        >
                                          ...
                                          <View style={{flexDirection:'row'}}>
                                            ...
                                            <Text style={[styles.textoconcepto,{ marginLeft:5,color: colors.text,paddingRight:10}]}>{concepto.nombre_entidad}</Text>
                                          </View>
...
export default EntidadesBeneficios